...
//     private apiUrl: string = 'http://mdm-api.humanitarian.tech/app_dev.php/api/v1';
...
//       //Replace /http://mdm-api.humanitarian.tech/app_dev.php/api/v1items by /textfile/txt if needed
//       this.http.get<ItemsRsponse>('http://mdm-api.humanitarian.tech/app_dev.php/api/v1items').retry(3)
//         .subscribe(data => {
...
//       this.http.post('http://mdm-api.humanitarian.tech/app_dev.php/api/v1developers/add', body, {
...
//     }
//
//     //GET an array method with Observable, replace any by actual return type
//     public getArrayObs () {
//       this.heroes = this.http.get(this.apiUrl)
//                     .switchMap(response => response.json().data as any);
//     }
//
//     //Handling errors
